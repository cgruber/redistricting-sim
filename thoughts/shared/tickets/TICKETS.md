...
| `GAME-116-generator-n-party-demographics.md` | game, tooling | Extend the pipeline demographics stage (hardcoded 2-party today) to N parties, so multiparty scenarios can be generated the "generator = initial state" way. Behavior-preserving for existing 2-party specs. Needed for the GAME-112 3-party demo |
---
