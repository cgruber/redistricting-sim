...
| `GAME-106-wip-restore-undo-correctness.md` | game, state, correctness | WIP save drops null precincts → bypasses all-assigned win-gate; validate/clamp stale WIP against regenerated scenario; zundo partialize+limit so undo doesn't revert activeDistrict |
