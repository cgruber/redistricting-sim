...
| `GAME-107-lint-format-gate.md` | game, build, ci, code-quality | Add a linter (Biome/ESLint) + formatter + CI gate to game/web — none today; systemic backstop for non-null asserts, literal drift, and the deploy reformat hazard |
---
