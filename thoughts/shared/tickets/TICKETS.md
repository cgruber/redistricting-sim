...
| `GAME-109-test-backstops-coverage.md` | game, testing, ci | Meta-test for unwired `_test.ts`; integration test globs scenarios instead of hardcoded table; unit tests for safe_seats/competitive_seats boundaries + getCriterionIcon; drop vestigial generator_lib dep |
---
