...
| `GAME-104-domain-single-sourcing.md` | game, code-quality, correctness | Single-source tie-break (R-vs-D contradiction between election & adapter), party set (5+ copies, one inverted), PARTY_COLORS (re-hardcoded in CSS), district palette + MAX_DISTRICTS |
