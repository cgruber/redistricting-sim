...
| `GAME-105-accessibility-pass.md` | game, accessibility, UX | Focus management on transitions (zero `.focus()` today, WCAG 2.4.3); overlay dialog/aria-modal/inert (tab into live editor behind result modal); keyboard-safe tutorial lock; role=listitem; dynamic key-range label |
