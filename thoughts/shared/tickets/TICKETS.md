...
| `GAME-110-verdict-logic-extraction.md` | game, code-quality, architecture | Move win/star verdict logic (computeStarCount/buildValidityRows) out of untested main.ts into simulation/verdict.ts; unify duplicated revealVerdict/syncOverallVerdict via applyVerdictUI (coordinate w/ GAME-074) |
---
