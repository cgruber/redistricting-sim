...
| `GAME-103-xss-hardening.md` | game, security | Escape scenario strings at innerHTML sinks (panels, hover, showLoadError) via shared helper; remove `data:` from CSP `script-src` via same-origin stub. Latent stored-XSS, armed by import/editor roadmap |
