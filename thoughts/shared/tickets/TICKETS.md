...
| `GAME-108-deploy-robustness.md` | game, build, deployment, tooling | `release.main.kts` hard-fail on failed index.html patch (currently warn+exit0 ships broken cache-bust/version); per-env idempotency state; genrule guard against misfiling future `assets/*.json` |
---
